...
exports.handler  = function(event, context) {
    ...
    */
    ...
    if(operation === 'login') {
        ...
        cognito.signup(payload.name, payload.email, payload.password, tokenCallback);
    }
        ...
        cognito.loginFederated(provider, payload.code, payload.clientId, payload.redirectUri, userId, tokenCallback);
    }
};
